      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="relative w-full max-w-md">
        <div className="bg-white/80 backdrop-blur-xl border border-gray-300/50 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <h1 style={{ fontWeight: 900, fontFamily: INTER, color: '#111827' }} className="text-3xl mb-2">Welcome Back</h1>
            <p className="text-gray-600">Sign in to continue your Ubuntu journey</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} required
                  className="w-full bg-white border border-gray-300 rounded-xl pl-12 pr-4 py-3 text-gray-800 placeholder-gray-400 focus:ring-2 focus:ring-[#E95420] outline-none transition-all"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPass ? 'text' : 'password'} value={form.password} onChange={(e) => setForm({ ...form, password: e.target.value })} required
                  className="w-full bg-white border border-gray-300 rounded-xl pl-12 pr-12 py-3 text-gray-800 placeholder-gray-400 focus:ring-2 focus:ring-[#E95420] outline-none transition-all"
                  placeholder="••••••••" />
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            {t('noAccount')}{' '}
            <Link to="/register" className="text-[#E95420] font-bold hover:underline">{t('signUp')}</Link>
          </p>
        </div>
      </motion.div>
    </div>
